 ...
 */
extern PyObject *modulecode_ppp(PyThreadState *tstate, PyObject *, struct Nuitka_MetaPathBasedLoaderEntry const *);

static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    {"ppp", modulecode_ppp, 0, 0, NUITKA_TRANSLATED_FLAG
